...
class request_quotation_revise(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(request_quotation_revise, self).__init__(cr, uid, name, context=context)
...
report_sxw.report_sxw('report.purchase.quotation.revise','purchase.order','addons/l10n_in_mrp_subcontract/report/request_quotation.rml',parser=request_quotation_revise,header=False)
