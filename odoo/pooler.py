...
def get_db_and_pool(db_name, force_demo=False, status=None, update_module=False):
    ...
    assert odoo.conf.deprecation.openerp_pooler
    _logger.warning('odoo.pooler.get_db_and_pool() is deprecated.')
...
def restart_pool(db_name, force_demo=False, status=None, update_module=False):
    ...
    _logger.warning('odoo.pooler.restart_pool() is deprecated.')
    assert odoo.conf.deprecation.openerp_pooler
