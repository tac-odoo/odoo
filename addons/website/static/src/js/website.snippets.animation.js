(function () {
  ...
  website.snippet.animationRegistry.gallery = website.snippet.Animation.extend({
    ...
    click_handler : function(event) {
        ...
        if (!edition_mode) {
            var urls = [], idx = undefined, milliseconds = undefined, params = undefined, $images = $cur.closest(".gallery").find("img");
            var dimensions = { 
            ...
            var params = { srcs : urls, index: idx, dim  : dimensions, interval : milliseconds, id: _.uniqueId("slideshow_") };
