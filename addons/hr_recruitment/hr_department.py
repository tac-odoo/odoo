...
class hr_department(models.Model):
    ...
    new_applicant_count = fields.Integer(
        compute='_new_applicant_count', string='New Applicant')
    new_hired_employee = fields.Integer(
        compute='_get_employee_stats', string='New Hired Employee')
    expected_employee = fields.Integer(
        compute='_get_employee_stats', string='Expected Employee')
