    ...
    def get_info(self, cr, uid, event_id, date_begin, date_end, context=None):
        ...
        for content in event.content_ids:
            result['contents'].append({
                'id': content.id,
                'name': content.name,
                'type_id': content.type_id.id or '',
                'course_id': content.course_id.id or '',
                'module_name': content.module_id.name if content.module_id else '',
                'module_id': content.module_id.id,
                'subject_name': content.subject_id.name or '',
