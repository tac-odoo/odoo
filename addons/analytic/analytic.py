...
class account_analytic_account(osv.osv):
    ...
    _columns = {
        ...
        'user_partner_id': fields.many2one('res.partner', 'Project Manager', track_visibility='onchange'),
    ...
    _defaults = {
        ...
        'state': 'open',
        'user_partner_id': lambda self, cr, uid, ctx: self.pool.get('res.users').browse(cr, uid, uid, context=ctx).partner_id.id,
