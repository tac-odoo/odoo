...
class account_analytic_account(osv.osv):
    ...
    _columns = {
        ...
        'project_manager_id': fields.many2one('res.partner', 'Project Manager', track_visibility='onchange'),
        'manager_id': fields.many2one('res.partner', 'Account Manager', track_visibility='onchange'),
    ...
    _defaults = {
        ...
        'state': 'open',
        'project_manager_id': lambda self, cr, uid, ctx: self.pool.get('res.users').browse(cr, uid, uid, context=ctx).partner_id.id,
