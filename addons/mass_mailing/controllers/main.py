...
class MassMailController(http.Controller):
    ...
    def unsubscribe(self, **post):
        ...
        contact_ids = [int(val) for val in request.httprequest.form.getlist('contact_ids')]
    ...
    def mailing(self, mailing_id, email=None, res_id=None, **post):
        ...
        if mailing.mailing_model == 'mail.mass_mailing.contact':
            ...
            return request.website.render('mass_mailing.page_unsubscribe', {'contacts': contacts or False, 'mailing_id': mailing_id, 'email': email})
        else:
            email_fname = None
