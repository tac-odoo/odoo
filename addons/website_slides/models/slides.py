...
class ir_attachment(models.Model):
    ...
    def set_like(self):
        self._cr.execute("""UPDATE ir_attachment SET likes = likes+1 WHERE id IN %s""", (tuple(self._ids),))
        return True

    def set_dislike(self):
        self._cr.execute("""UPDATE ir_attachment SET dislikes = dislikes+1 WHERE id IN %s""", (tuple(self._ids),))
        return True
