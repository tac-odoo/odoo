...
class account_move_line(models.Model):
    ...
    debit = fields.Float(string='Debit', digits=0, default=0.0)
    credit = fields.Float(string='Credit',  digits=0, default=0.0)
    ...
    tax_amount = fields.Float(string='Tax/Base Amount', digits=0, index=True,
