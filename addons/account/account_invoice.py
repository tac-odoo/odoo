...
class account_invoice_tax(models.Model):
    ...
    base = fields.Float(string='Base', digits=0)
    ...
    base_amount = fields.Float(string='Base Code Amount', digits=0,
        default=0.0)
    tax_code_id = fields.Many2one('account.tax.code', string='Tax Code',
        help="The tax basis of the tax declaration.")
    tax_amount = fields.Float(string='Tax Code Amount', digits=0,
        default=0.0)
