...
class AccountBalanceReport(models.AbstractModel, common_report_header):
    ...
    #     if data.get('form', False) and data['form'].get('filter', False) == 'filter_no':
    #         return 'Not filtered'
    #     elif data.get('form', False) and data['form'].get('filter', False) == 'filter_period':
    #         return 'Filtered by period'
    #     elif data.get('form', False) and data['form'].get('filter', False) == 'filter_date':
