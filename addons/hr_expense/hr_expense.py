...
class hr_expense_expense(osv.osv):
    ...
    _columns = {
        ...
        'user_id': fields.related('employee_id', 'user_id', type='many2one', relation='res.users', string='User', track_visibility="onchange"),
    ...
    def onchange_employee_id(self, cr, uid, ids, employee_id, context=None):
        ...
        return {'value': {'department_id': department_id, 'company_id': company_id, 'employee_payable_account_id': employee_payable_account_id, 'user_id': user_id}}
