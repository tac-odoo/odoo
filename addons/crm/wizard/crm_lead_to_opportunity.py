...
class crm_lead2opportunity_partner(osv.osv_memory):
    ...
    def action_apply(self, cr, uid, ids, context=None):
        ...
        if w.name == 'merge':
            ...
            self._convert_opportunity(cr, uid, ids, {'lead_ids': lead_ids, 'partner_id': w.partner_id.id, 'partner_name': w.partner_name, 'user_ids': [w.user_id.id], 'section_id': w.section_id.id}, context=context)
