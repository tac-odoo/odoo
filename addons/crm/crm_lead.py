...
class crm_lead(format_address, osv.osv):
    ...
    _columns = {
        ...
        'tag_ids': fields.many2many('crm.lead.tag', 'crm_lead_category_rel', 'lead_id', 'category_id', 'Tags', \
            domain="['|', ('section_id', '=', section_id), ('section_id', '=', False)]", help="Classify and analyze your lead/opportunity categories like: Training, Service"),
        'type_id': fields.many2one('crm.campaign', 'Campaign', \
            domain="['|',('section_id','=',section_id),('section_id','=',False)]", help="From which campaign (seminar, marketing campaign, mass mailing, ...) did this contact come from?"),
        'channel_id': fields.many2one('crm.channel', 'Channel', help="Communication channel (mail, direct, phone, ...)"),
