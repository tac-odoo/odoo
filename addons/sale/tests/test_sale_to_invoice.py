...
class TestSale(TestMail):
    ...
    def test_sale_to_invoice(self):
        ...
        account_id = DataObj.xmlid_to_res_id('account.cash') or False   
        company_id = DataObj.xmlid_to_res_id('base.main_company') or False
        journal_id = DataObj.xmlid_to_res_id('account.bank_journal') or False
        period_id  = DataObj.xmlid_to_res_id('account.period_8') or False
