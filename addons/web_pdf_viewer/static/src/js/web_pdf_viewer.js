openerp.web_pdf_viewer = function (openerp) {
	openerp.web.ActionManager.include({
		ir_actions_report_xml: function(action, options) {
	        var self = this;
	        action["mod_installed"] = true;
	        openerp.web.blockUI();
	        if((action.hasOwnProperty('report_type') && (action.report_type == 'qweb-pdf' || action.report_type == 'pdf')) || !(action.hasOwnProperty('report_type')))
	        {	
		        return openerp.web.pyeval.eval_domains_and_contexts({
