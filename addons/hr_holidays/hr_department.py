...
class hr_department(models.Model):
    ...
    absence_of_today = fields.Integer(
        compute='_leave_count', string='Absence by Today')
    leave_to_approve_count = fields.Integer(
        compute='_leave_count', string='Leave to Approve')
    allocation_to_approve_count = fields.Integer(
        compute='_leave_count', string='Allocation to Approve')
    total_employee = fields.Integer(
        compute='_get_total_employee', string='Total Employee')
